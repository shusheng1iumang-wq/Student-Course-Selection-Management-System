...
void Save_mcl(Major_Code_List* mcl_head);     //保存链表到文件
...
void copy_mcl_item_without_next(Major_Code_List* paste,Major_Code_List* wall);      //复制mcl_item
void Read_major_code_list(Major_Code_List * mcl_head);   //读取major文件
